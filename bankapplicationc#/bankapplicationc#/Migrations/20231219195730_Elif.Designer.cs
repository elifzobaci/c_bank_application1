...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bankapplicationc_.classes.Transfer", b =>
                {
                    ...
                    b.Property<int?>("TransactionLogId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("bankapplicationc_.classes.TransactionLog", b =>
                {
                    b.HasOne("bankapplicationc_.classes.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("bankapplicationc_.classes.Transfer", b =>
                {
                    ...
                    b.HasOne("bankapplicationc_.classes.TransactionLog", "TransactionLog")
                        .WithMany()
                        .HasForeignKey("TransactionLogId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("bankapplicationc_.classes.TransactionLog", null)
                        .WithMany("Transfers")
                        .HasForeignKey("TransactionLogId1");
